...
class SignupScreen extends StatelessWidget {
              ...
              children: [
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: ValueListenableBuilder<bool>(valueListenable: _loadingcircle, builder: (context, loading, child){
                        return loading
  ...
  void signup(BuildContext context) {
    ...
    _auth.createUserWithEmailAndPassword(email: emailcontroller.text.toString(),
      ...
      Utils().toastMessage("SignUp Successfully!", Colors.green.shade400);
      Navigator.push(
